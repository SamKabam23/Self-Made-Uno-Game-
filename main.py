...
#printt("THE PROGRAM IS CURENTLEY UNDERGOING CHANGES, BUGS MAY OCCUR THAT ARE NOT IN THE NORMAL GAME")
#time.sleep(5)
#os.system('clear')
...
def judge(theone,thedeck):
  ...
  if theone!='/':
    ...
    if theone in deck1 or theone in sumoo[:len(deck1)+1]:
        if theone.isdigit():
...
def compturn():
  ...
  choose=False
  iseeu2=""
  printt("\nThe computer is making it's move..")
  time.sleep(2)
  global deck,start,dicts,skipp2,wildz
  if '+4 Card' in deck2:
